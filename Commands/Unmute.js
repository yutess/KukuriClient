    ...
    async execute(message, args, client) {
        try {
            ...
            if (fs.existsSync(configPath)) {
                ...
                return message.reply('Mute role not configured. Please use .mutesetup [Role ID] first');
            }
            ...
            message.reply('An error occurred while trying to unmute. Please try again');
        }
    }
};